# Banco de Dados: Uma Aplicação CRUD - parte 1
...
=======
>>>>>>> e25fcb831f1854273afa49c1717b55c69d583ba6

------------------------------------------------------------------------
Esta interface será construida através do modelo cliente-servidores onde:

```{plantuml aula-09-diagrama-cliente-servidor-02, plantuml.path="images"}
@startuml
skinparam componentStyle rectangle
...
```{plantuml aula-09-diagrama-cliente-servidor-02-mvc, plantuml.path="images"}
@startuml
top to bottom direction
skinparam linetype ortho
skinparam packageStyle frame
